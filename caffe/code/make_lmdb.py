...
PASCAL_FOLDER = '/home/carolina/projects/MESMERISE/DeepLab/benchmark_RELEASE/dataset/' 
IDS_FILE = sys.argv[1];
if IDS_FILE == 't':
	IDS_FILE = PASCAL_FOLDER + 'train_id.txt'
elif IDS_FILE == 'v':
	IDS_FILE = PASCAL_FOLDER + 'train_id.txt'
...
if DIR == 'i':
	DIR = PASCAL_FOLDER + 'JPEGImages/'
	 ...
	 DIR = PASCAL_FOLDER + 'SegmentationClassAug/'
